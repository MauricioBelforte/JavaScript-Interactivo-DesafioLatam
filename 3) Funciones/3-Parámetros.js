...
Ejercicio
Se ha definido una función llamada mostrarMensajeSecreto. Esta función depende de un parámetro llamado mensaje. Si el mensaje es "secreto", mostrará "Mensaje correcto". Sin embargo, si el mensaje es cualquier otro, mostrará "Mensaje incorrecto".
...
function mostrarMensajeSecreto(mensaje){
  ...
  console.log("Término de la función");
} 
*/
...
mostrarMensajeSecreto("secreto");
mostrarMensajeSecreto("no secreto")

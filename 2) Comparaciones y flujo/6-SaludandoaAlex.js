...
Ejercicio
Se ha diseñado un programa en JavaScript con la intención de mostrar un mensaje de bienvenida a los usuarios cuyo nombre coincide con "Alex".
...
nombreUsuario = "Alex" /* Modifica esta línea */ 
if (nombreUsuario == "Alex") 
  console.log("Bienvenido, Alex")

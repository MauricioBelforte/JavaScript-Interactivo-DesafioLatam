...
Buenas prácticas
La indentación (Espaciado / Sangría) previo a la instrucción console.log es opcional, pero es una buena práctica dado que nos ayuda a entender a simple vista cuáles instrucciones se ejecutarán si la condición es verdadera.

Ejercicio
El siguiente programa tiene un problema, alguien cambió la contraseña y ahora no funciona correctamente. Debería mostrar que el código es correcto si la variable codigo es igual a "1234". Sin embargo, el programa no muestra nada en absoluto. ¿Puedes corregirlo?
